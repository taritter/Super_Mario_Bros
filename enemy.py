...
class Enemy(arcade.AnimatedTimeBasedSprite):
    def __init__(self): #5.19 #original ===self, name_folder, name_file):
        print("in here")
        super().__init__()
    ...
    def update(self, delta_time: float= 1/60):
        ...
        if self.flipped_frames is None:
            ...
            self.flipped_frames = self.load_flipped_images(self.frames) #fix this to texture set?
